...
% TO-DO: in the results section, say that the manual process of converting or inventing the tasks is pretty tedious, and we require more effort than most existing benchmarks, as we have to make them so customizeable, and keep it in mind.

% TO-DO: create a table to calculate the CO2 emissions from executing some tasks from my benchmarks
...
\begin{enumerate}
    \item In the Chapter ``State of Art'', we introduce the existing benchmarks, and how they solved the problems of the ones before them.
...
% TO-DO complete the description
